...
> 副标题：AI Agent 的持续学习：模型、运行框架与上下文三层

| | |
|---|---|
| **原始标题** | Continual Learning for AI Agents |
| **原始链接** | [blog.langchain.com](https://blog.langchain.com/continual-learning-for-ai-agents) |
| **原始发表日期** | 2026-04-04 |
| **归档日期** | 2026-04-07 |
| **分类** | [AI & 机器学习](../../archive/ai-ml/README.md) |
| **标签** | `AI Agent` `持续学习` `Coding Agent` `知识管理` `LangSmith` |
